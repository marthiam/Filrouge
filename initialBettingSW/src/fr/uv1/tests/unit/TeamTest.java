...
public class TeamTest {
	...
	public void testAddMember() throws BadParametersException,
		...
		assertTrue(myTeam.getMembers().contains(
				new Individual("Thiam", "Fatou", "11-03-1992")));

	}

	@Test(expected = ExistingCompetitorException.class)
	public void testInvalidAddMember() throws BadParametersException,
			ExistingCompetitorException {
		Collection<Competitor> members = new HashSet<Competitor>();
		members.add(new Individual("Thiam", "Maurice", "22-09-1992"));
		members.add(new Individual("Ketevi", "Mariam", "02-11-1992"));
	...
	@Test
	public void testDeletMember() throws BadParametersException,
			ExistingCompetitorException {
		Collection<Competitor> members = new HashSet<Competitor>();
		members.add(new Individual("Thiam", "Maurice", "22-09-1992"));
		members.add(new Individual("Ketevi", "Mariam", "02-11-1992"));
		...
		assertTrue(myTeam.getMembers().size() == 1);
		assertFalse(myTeam.getMembers().contains(
				new Individual("Ketevi", "Mariam", "02-11-1992")));

	}

	@Test(expected = ExistingCompetitorException.class)
	public void testInvalidRemoveMember() throws BadParametersException,
			ExistingCompetitorException {
		Collection<Competitor> members = new HashSet<Competitor>();
		members.add(new Individual("Thiam", "Maurice", "22-09-1992"));
		members.add(new Individual("Ketevi", "Mariam", "02-11-1992"));
