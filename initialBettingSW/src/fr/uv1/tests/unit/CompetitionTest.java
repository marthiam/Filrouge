...
public class CompetitionTest extends Thread {
	...
	public void testCompetition() throws BadParametersException,
		...
		competition = new Competition(new String("1-Tennis_2"), new MyCalendar(
				2014, 12, 1), competitors);
		assertTrue(competition.getNomCompetition().equalsIgnoreCase(
				new String("1-Tennis_2")));
		assertTrue(competition.getMontantTotalMise() == 0);
		assertTrue(competition.getCompetitors().contains(
				new Individual("Cisse", "Mamadou", "28-09-1992")));
		assertTrue(competition.getCompetitors().contains(
				new Individual("Cisse", "Sanounou", "05-01-1989")));
		assertTrue(competition.getCompetitors().contains(
				new Individual("Cisse", "Pinda", "07-10-1990")));
		assertTrue(competition.getCompetitors().size() == 5);

	}

	@Test
	public void testAddCompetitor() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
				2014, 12, 1), competitors);
		competition.addCompetitor((new Individual("Thiam", "Mariam",
				"07-10-1990")));
		assertTrue(competition.getCompetitors().contains(
				new Individual("Thiam", "Mariam", "07-10-1990")));
		assertTrue(competition.getCompetitors().size() == 6);
	}

	@Test(expected = BadParametersException.class)
	public void testAddNullCompetitor() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
				2014, 12, 1), competitors);
	...
	public void testAddExistingCompetitor() throws BadParametersException,
			CompetitionException, ExistingCompetitionException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
				2014, 12, 1), competitors);
		int oldsize = competition.getCompetitors().size();
		competition
				.addCompetitor(new Individual("Cisse", "Pinda", "07-10-1990"));
	}

	@Test(expected = BadParametersException.class)
	public void testAddBadCompetitor() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competition.addCompetitor((new Individual("Thiam", "Mariam",
				"07-10-200")));
	}
	...
	@Test
	public void testParierSurLeVainqueur() throws BadParametersException,
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurNullparierSurLeVainqueur()
	...
	@Test(expected = BadParametersException.class)
	public void testparierSurLeVainqueurZeroMise()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurBadMise()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
	...
	public void testParierSurLeVainqueurBadMise1()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLeVainqueurByCompetitor()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competitors.add(new Individual("Cisse", "Sanounou", "05-01-1989"));
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurByNullSubscriber()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLeVainqueurOfPassCompetition()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competition = new Competition(new String("Tennis"), new MyCalendar(
				2014, 4, 1), competitors);
		sub = new Subscriber("Cisse", "Kadi", "07-10-1990", "mcisse");
	...
	@Test
	public void testAddTeam() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testAddExistingTeam() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
		Team t1 = new Team("Telecom");
		t1.addMember(new Individual("Cisse", "Mamadou", "28-09-1992"));
	...
	@Test(expected = BadParametersException.class)
	public void testAddNullTeam() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
		Team t1 = new Team("Telecom");
		t1.addMember(new Individual("Cisse", "Mamadou", "28-09-1992"));
	...
	@Test(expected = CompetitionException.class)
	public void testAddTeamToPassCompetition() throws BadParametersException,
			CompetitionException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
		Team t1 = new Team("Telecom");
		t1.addMember(new Individual("Cisse", "Mamadou", "28-09-1992"));
		...
		competitors.add(t2);
		competition = new Competition(new String("Tennis"), new MyCalendar(
				2014, 3, 1), competitors);
		competition.addCompetitor(t3);

	}

	@Test
	public void testParierSurLePodium() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
		...
		sub = new Subscriber("Cisse", "Kadi", "07-10-1990", "mcisse");
		sub.crediter(300);
		competition = new Competition(new String("basket"), new MyCalendar(
				2014, 12, 1), competitors);
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumNull() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumZeroMise() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumBadMise() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = SubscriberException.class)
	public void testParierSurLePodiumBadMise1() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLePodiumByCompetitor()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
		Team t1 = new Team("Telecom");
		t1.addMember(new Individual("Cisse", "Mamadou", "28-09-1992"));
		t1.addMember(new Individual("Cisse", "Sanounou", "05-01-1989"));
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumByNullSubscriber()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLePodiumOfPassCompetition()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test
	public void testParierSurLePodiumIndiv() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumNullIndiv() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumZeroMiseIndiv()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumBadMiseInd()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = SubscriberException.class)
	public void testParierSurLePodiumBadMise1Indiv()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLePodiumByCompetitorIndiv()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLePodiumByNullSubscriberIndiv()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLePodiumOfPassCompetitionIndiv()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test
	public void testParierSurLeVainqueurTeam() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurNullTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurZeroMiseTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurBadMiseTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = SubscriberException.class)
	public void testParierSurLeVainqueurBadMise1Team()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLeVainqueurByCompetitorTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testParierSurLeVainqueurByNullSubscriberTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLeVainqueurOfPassCompetitionTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLePodiumOfCompetionWith2CompetitorsTeam()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testParierSurLePodiumOfCompetionWith2CompetitorsIndiv()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = BadParametersException.class)
	public void testSolderPariNullWinner() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException {
		competitors = new ArrayList<Competitor>();
		Competitor c1 = new Individual("Cisse", "Mamadou", "28-09-1992");
		...
		sub = new Subscriber("Cisse", "Kadi", "07-10-1990", "mcisse");
		sub.crediter(300);
		Subscriber sub2 = new Subscriber("Cisse", "Oumou", "07-10-1990",
				"ocisse");
		sub2.crediter(300);
	...
	@Test(expected = CompetitionException.class)
	public void testSolderPariWinnerNotExistCompetitor()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competitors = new ArrayList<Competitor>();
		...
		competition.parierSurLeVainqueur(pariwin);
		competition.parierSurLeVainqueur(pariwin2);
		competition.solderPariWinner(new Individual("Diarra", "Ousmane",
				"01-06-1970"));
	}

	@Test(expected = CompetitionException.class)
	public void testSolderPariWinnerBeforeClosingDate()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException {
		competitors = new ArrayList<Competitor>();
	...
	public void testSolderPariWinner() throws BadParametersException,
		...
		competition = new Competition(new String("Course"), new MyCalendar(
				2014, 12, 18), competitors);
		Subscriber sub1 = new Subscriber("Cisse", "Soumaila", "07-10-1982",
				"soumailacisse");
		sub1.crediter(100);
		Subscriber sub2 = new Subscriber("Cisse", "Hadji", "07-10-1990",
				"hadjicisse");
		sub2.crediter(100);
		PariWinner pariwin = new PariWinner(100, sub1, c1);
		...
		assertTrue("" + sub1.solde(), sub1.solde() == 160);
		MyCalendar.setDate();
	}

	@Test(expected = BadParametersException.class)
	public void testSolderPariPodiumNullWinner() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException {
		competitors = new ArrayList<Competitor>();
		Competitor c1 = new Individual("Cisse", "Mamadou", "28-09-1992");
	...
	@Test(expected = BadParametersException.class)
	public void testSolderPariPodiumNullSecond() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException {
		competitors = new ArrayList<Competitor>();
		Competitor c1 = new Individual("Cisse", "Mamadou", "28-09-1992");
	...
	@Test(expected = BadParametersException.class)
	public void testSolderPariPodiumNullThird() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException {
		competitors = new ArrayList<Competitor>();
		Competitor c1 = new Individual("Cisse", "Mamadou", "28-09-1992");
	...
	@Test(expected = CompetitionException.class)
	public void testSolderPariPodiumWinnerNotExist()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testSolderPariPodiumSecondNotExist()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testSolderPariPodiumThirdNotExist()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test(expected = CompetitionException.class)
	public void testSolderPariPodiumBeforeClosingDate()
			throws BadParametersException, CompetitionException,
			AuthenticationException, ExistingCompetitionException,
			SubscriberException, ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
	...
	@Test
	public void testSolderPariPodium() throws BadParametersException,
			CompetitionException, AuthenticationException,
			ExistingCompetitionException, SubscriberException,
			ExistingCompetitorException {
		competitors = new ArrayList<Competitor>();
