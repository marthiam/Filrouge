...
public class SubscribersManager {
	...
	public static Subscriber findById(Integer id) throws SQLException,
		...
		PreparedStatement psSelect = c
				.prepareStatement("select * from personne where  id_personne=? and  type =?");
	...
	public static List<Subscriber> findAll() throws SQLException,
		...
		Connection c = DataBaseConnection.getConnection();
		PreparedStatement psSelect = c
				.prepareStatement("select * from personne where type=? order by id_personne");
	...
	public static void update(Subscriber subscriber) throws SQLException {
		...
		PreparedStatement psUpdate = c
				.prepareStatement("update personne set prenom=?, nom=?,borndate=?,type=?,username=?,password=?,solde=?  where id_personne=?");
